...
import { ActivityIndicator, Alert, Image, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, ImageBackground } from 'react-native';
...
const InputLaporanScreen = () => {
    ...
    const handleSave = () => {
        ...
        // Pilih lokasi manual jika ada, jika tidak pakai lokasi otomatis
        const lat = manualLatitude ? parseFloat(manualLatitude) : location?.latitude;
        const lng = manualLongitude ? parseFloat(manualLongitude) : location?.longitude;

        if (!lat || !lng) {
            Alert.alert('⚠️ Peringatan', 'Silakan isi lokasi (manual atau ambil lokasi saat ini).');
            return;
        }
        ...
        const newReport = {
            ...
            accuration: location?.accuracy || 0,
                    ...
                    <SafeAreaView style={styles.container} edges={['top']}>
                        ...
                        <ScrollView contentContainerStyle={styles.scrollContent}>
                            <View style={styles.formContainer}>
                                ...
                                {/* Input lokasi manual */}
                                <ThemedText type="subtitle" style={styles.label}>Lokasi Manual (opsional)</ThemedText>
...
export default InputLaporanScreen;
